...
"""
        ...
        with (
            ...
            patch(
                ...
                return_value={
                    ...
                    "body": "Product Background의 200 크레딧 중 5 크레딧을 사용하게 돼요. 크레딧이 더 필요하신가요? 구매하기",
                },
            ),
            patch(
                "runtime_v2.workers.agent_browser_worker._click_visible_page_locator",
    ...
    def test_canva_background_generate_surfaces_credit_exhausted(
        self,
    ) -> None:
        from runtime_v2.workers.agent_browser_worker import (
            _playwright_canva_background_generate,
        ...
        self.assertEqual(result["error"], "CANVA_PRODUCT_BACKGROUND_CREDIT_EXHAUSTED")
        self.assertTrue(bool(result["upload_attempted"]))
        self.assertIn("남은 크레딧이 없습니다", str(result["body"]))

    def test_canva_background_generate_frame_surfaces_credit_exhausted(self) -> None:
        from runtime_v2.workers.agent_browser_worker import (
            _playwright_canva_background_generate,
        )
    ...
    def test_canva_background_generate_surfaces_credit_gate_required(
        self,
    ) -> None:
        from runtime_v2.workers.agent_browser_worker import (
            _playwright_canva_background_generate,
        ...
        with (
            ...
            patch(
                ...
                return_value={
                    ...
                    "file_select_visible": True,
                    "generate_visible": True,
                    "body": "Product Background의 200 크레딧 중 5 크레딧을 사용하게 돼요.\n크레딧이 더 필요하신가요? 구매하기\n파일 선택하기\n생성",
                },
            ),
        ):
            result = _playwright_canva_background_generate(
