...
class RuntimeV2Stage1ChatgptTests(unittest.TestCase):
    ...
    def test_build_live_chatgpt_prompt_requests_stage1_block_contract(self) -> None:
        ...
        self.assertIn("Return only these labeled blocks", prompt)
        ...
        self.assertIn("do not use placeholder values like ...", prompt)
        self.assertIn("keep scene numbers sequential from 01", prompt)
