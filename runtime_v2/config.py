...
class RuntimeConfig:
    ...
    browser_registry_file: Path = Path("system/runtime_v2/health/browser_session_registry.json")
    gpt_status_file: Path = Path("system/runtime_v2/health/gpt_status.json")
    control_plane_events_file: Path = Path("system/runtime_v2/evidence/control_plane_events.jsonl")
