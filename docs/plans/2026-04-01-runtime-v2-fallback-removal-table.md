...
- The still-retained fallbacks are now concentrated in `genspark` capture selection and placeholder/probe scaffolding, where the upstream contract is not yet pinned tightly enough.
