...
- The still-retained fallbacks are now concentrated in `genspark` capture selection and placeholder/probe scaffolding, where the caller/capture contract is not yet reduced to a single generic path.
