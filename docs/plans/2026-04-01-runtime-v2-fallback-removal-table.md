...
- The still-retained fallbacks are now concentrated in `stage1` response retry and `genspark` capture selection, where the upstream browser contract is not yet pinned tightly enough.
