...
| Timeline / SRT / shorts ops | `D:\YOUTUBE_AUTO\scripts\timeline_generator.py`, `srt_generator.py`, `shorts_render.py` | partial indirect coverage only | Partially Covered | runtime_v2 covers render and some stage contracts, but no 1:1 explicit timeline/srt/shorts program mapping is documented |
