...
- `D:\YOUTUBEAUTO_RUNTIME\probe\stage2-noncanva-20260521-a\probe_result.json`, `D:\YOUTUBEAUTO_RUNTIME\probe\stage5-row15-20260524-a\probe_result.json` - non-Canva 핵심 체인은 `OK` 상태이며, semantic target row closeout도 성공 닫힘 상태입니다.
